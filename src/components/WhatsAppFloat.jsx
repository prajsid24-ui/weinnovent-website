        ...
        <AnimatePresence>
          {tooltip && (
            ...
            >
              ...
              <div style={{
                position: 'absolute', right: 16, bottom: -5,
                width: 10, height: 10,
                background: '#1a1a1a',
        ...
        {showBar && (
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
              ...
              <div>
                <p style={{ fontSize: 13, fontWeight: 600, color: '#fff', marginBottom: 1 }}>
                  Ready to elevate your brand?
                </p>
                <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.45)' }}>
                  Free strategy call · No commitment · Reply in 2 hours
                </p>
              </div>
            </div>
